      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <img
            ...
            alt=""
            aria-hidden
            className="pointer-events-none absolute -left-[25%] top-[2%] h-auto w-[150%] max-w-none select-none opacity-[0.38] [filter:sepia(0.08)_saturate(0.25)_brightness(1.28)_contrast(0.8)] [mask-image:radial-gradient(60%_60%_at_50%_50%,black_35%,transparent_100%)] md:-left-[12%] md:top-[-14%] md:w-[112%] md:opacity-[0.32]"
          />
        ...
        <section id="final" className="rule-thin relative overflow-hidden">
          ...
          <img
            ...
            alt=""
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-1/2 h-auto w-[150%] max-w-none -translate-x-1/2 -translate-y-1/2 select-none opacity-[0.40] [filter:sepia(0.08)_saturate(0.25)_brightness(1.28)_contrast(0.8)] [mask-image:radial-gradient(60%_60%_at_50%_50%,black_35%,transparent_100%)] md:w-[100%] md:opacity-[0.34]"
          />
